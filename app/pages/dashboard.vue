    ...
    <section>
      <div class="stats-grid">
        <Card>
          <template #content>
            <div style="display: flex; align-items: center; gap: 1rem;" role="status" aria-live="polite">
              <i class="pi pi-users" style="font-size: 2rem; color: var(--p-blue-500);" aria-hidden="true" />
              <div>
        ...
        <Card>
          <template #content>
            <div style="display: flex; align-items: center; gap: 1rem;" role="status" aria-live="polite">
              <i class="pi pi-graduation-cap" style="font-size: 2rem; color: var(--p-green-500);" aria-hidden="true" />
              <div>
                <p style="font-size: 0.875rem; color: var(--p-text-muted-color);">
                  Youth Records
                </p>
        ...
        <Card>
          <template #content>
            <div style="display: flex; align-items: center; gap: 1rem;" role="status" aria-live="polite">
              <i class="pi pi-user" style="font-size: 2rem; color: var(--p-purple-500);" aria-hidden="true" />
              <div>
                <p style="font-size: 0.875rem; color: var(--p-text-muted-color);">
                  Total Users
                </p>
